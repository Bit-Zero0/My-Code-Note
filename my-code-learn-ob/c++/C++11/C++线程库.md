...
4. `std::recursive_timed_mutex`
	`std::recursive_timed_mutex` 是一个同步原语，可以用来保护共享数据不被多个线程同时访问。它类似于 `std::recursive_mutex`，提供了排他性的递归所有权语义。也就是说，一个线程可以多次锁定同一个互斥锁，只要在解锁时匹配相同的次数。此外，`std::recursive_timed_mutex` 还提供了通过 `try_lock_for` 和 `try_lock_until` 成员函数在指定的超时时间内尝试获取互斥锁的能力
...
![image.png](https://image-1311137268.cos.ap-chengdu.myqcloud.com/SiYuan/20230323193422.png)
...
Atomic 经常搭配 memory_order 进行使用 , 如atomic 中的load 和 store方法:
...
![image.png](https://image-1311137268.cos.ap-chengdu.myqcloud.com/SiYuan/20230601224327.png)

![image.png](https://image-1311137268.cos.ap-chengdu.myqcloud.com/SiYuan/20230601224400.png)

接下来 我们看看 memory_order 是何方神圣吧!!
...
# 线程同步
![Pasted image 20221017172529.png](https://image-1311137268.cos.ap-chengdu.myqcloud.com/SiYuan/Pasted%20image%2020221017172529.png)


## 条件变量函数
### wait()
![Pasted image 20221017171307.png](https://image-1311137268.cos.ap-chengdu.myqcloud.com/SiYuan/Pasted%20image%2020221017171307.png)
...
![Pasted image 20221017171834.png](https://image-1311137268.cos.ap-chengdu.myqcloud.com/SiYuan/Pasted%20image%2020221017171834.png)
...
![Pasted image 20221017165427.png](https://image-1311137268.cos.ap-chengdu.myqcloud.com/SiYuan/Pasted%20image%2020221017165427.png)
...
```
运行此时运行就没有问题了。
![Pasted image 20221017170421.png](https://image-1311137268.cos.ap-chengdu.myqcloud.com/SiYuan/Pasted%20image%2020221017170421.png)
