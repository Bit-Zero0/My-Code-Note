...
文件结构如下：
![image.png](https://image-1311137268.cos.ap-chengdu.myqcloud.com/SiYuan/20230315181740.png)
...
这是我们的文件
![image.png](https://image-1311137268.cos.ap-chengdu.myqcloud.com/SiYuan/20230315181958.png)


第一次使用`make`指令后
![image.png](https://image-1311137268.cos.ap-chengdu.myqcloud.com/SiYuan/20230315182016.png)



第二次使用`make`指令，提示我们的版本已经是最新的，意思就是我们的源文件没有任何改动。如果源文件有改动，则又可以使用 `make`指令
![image.png](https://image-1311137268.cos.ap-chengdu.myqcloud.com/SiYuan/20230315182034.png)
...
被红框的文件就是我们需要删除的文件。
![image.png](https://image-1311137268.cos.ap-chengdu.myqcloud.com/SiYuan/20230315182053.png)


使用 `make clean`指令
![image.png](https://image-1311137268.cos.ap-chengdu.myqcloud.com/SiYuan/20230315182134.png)

![image.png](https://image-1311137268.cos.ap-chengdu.myqcloud.com/SiYuan/20230315182117.png)
...
![image.png](https://image-1311137268.cos.ap-chengdu.myqcloud.com/SiYuan/20230315182232.png)


使用make命令运行后
![image.png](https://image-1311137268.cos.ap-chengdu.myqcloud.com/SiYuan/20230315182310.png)


得到的文件也是一样的
![image.png](https://image-1311137268.cos.ap-chengdu.myqcloud.com/SiYuan/20230315182322.png)
...
![image.png](https://image-1311137268.cos.ap-chengdu.myqcloud.com/SiYuan/20230315182452.png)
